...
public abstract class BinaryInt extends Function {
  ...
  public abstract TypeData data_type( IntTypeData a, IntTypeData b );
  public abstract String op();
  
  public Variable compile_checked( Variable<IntTypeData>[] args, Statement owner ) throws CompileException {
    TypeData data = data_type( args[0].getData(), args[1].getData() );
